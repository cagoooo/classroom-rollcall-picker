...
${absentList.join("、") || "（無）"}`;
  ...
  // ==========================================================================
  // ONBOARDING QUICKSTART GUIDE MODAL
  // ==========================================================================
  ...
  function closeHelpModal() {
    ...
    localStorage.setItem("classbuddy_onboarded", "true");
  }
  ...
  const hasOnboarded = localStorage.getItem("classbuddy_onboarded");
  if (!hasOnboarded) {
    // delay slightly to let canvas and styling render smoothly
    setTimeout(() => {
      helpModal.classList.add("active");
    }, 800);
  }
